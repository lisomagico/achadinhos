...
Crie um post chamativo com emojis, urgência e o link no final. Só o texto do post, sem explicações e deixando sempre um espaço estrategicos para o texto ficar organizado, curto e objetivo (se for colocar algumas informações em negrito, lembre que só basta uma * no começo da frase e uma * no final.`;
